 ...
 * Copyright (C) 
 *
 * Author: Alexander Gro�mann, University of Erlangen-Nuernberg, 2017
 */
...
namespace StepRod {
    ...
    template <int dim, int spacedim>
    ElasticRod<dim, spacedim>::ElasticRod()
    :
    ...
    template <int dim, int spacedim>
    void ElasticRod<dim, spacedim>::third_grid(
            const double &len,
            const double &radius,
            const int &n_of_ref) {
    ...
    template <int dim, int spacedim>
    void ElasticRod<dim, spacedim>::setup_system(const bool first_step) {
        if (first_step) {
    ...
    template <int dim, int spacedim>
    void ElasticRod<dim, spacedim>::assemble_system() {
        /*
    ...
    template <int dim, int spacedim>
    void ElasticRod<dim, spacedim>::solve() {
     ...
     */
    template <int dim, int spacedim>
    void ElasticRod<dim, spacedim>::output_results(const unsigned int cycle) const {
    ...
    template <int dim, int spacedim>
    void ElasticRod<dim, spacedim>::run() {
        third_grid(1, 0.2, 5);
...
int main() {
    try {
        ...
        StepRod::ElasticRod<1, 1> elastic_problem_3d;
